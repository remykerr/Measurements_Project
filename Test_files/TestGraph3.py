# -*- coding: utf-8 -*-
"""
Created on Sat Jun 20 21:28:25 2026
...
Test_Circuit_Dir = Base_Dir / "trial_run_random_long"
Model_File = Base_Dir / "knn_surface_classifie_fullclasses.joblib"
...
<i style="background:#D955D9;width:14px;height:14px;float:left;margin-right:8px;opacity:0.8;"></i>
Cobble<br><br>

<i style="background:#49F527;width:14px;height:14px;float:left;margin-right:8px;opacity:0.8;"></i>
Grass<br><br>

<i style="background:#0724ED;width:14px;height:14px;float:left;margin-right:8px;opacity:0.8;"></i>
Unpaved<br><br>
