...
# Additional debug for the time series containing the defect

DEBUG_SURFACE = "Speedbump"
DEBUG_MEASUREMENT = 6
DEBUG_WINDOW_INDEX = [15]

window_df, debug_data = build_surface_dataset_anomaly(
    plot_debug=True,
    return_debug=True,
    plot_debug_acc = True,
    debug_surface=DEBUG_SURFACE,
