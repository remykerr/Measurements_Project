...
def build_surface_dataset_anomaly(
    ...
    for surface in surface_types:
        ...
        for measurement_id in ids_to_process:
            ...
            original_segments = np.asarray(segments)
            segments = original_segments
            if target_window_size is not None and segments.shape[1] != target_window_size:
            ...
            if collect_debug:
                ...
                debug_data[debug_key] = {
                    ...
                    "target_window_size": segments.shape[1],
                    ...
                    "debug_original_segments": {
                        index: original_segments[index].copy()
                        for index in debug_window_indices_safe
                    },
                }
            ...
            if plot_debug and collect_debug:
                print(
                    ...
                    f"of size {segments.shape[1]} samples "
                ...
                for index in debug_data[f"{surface}_{measurement_id}"]["debug_window_indices"]:
                    ...
                    debug_time = np.linspace(
                        0,
                        window_size / current_fsamp,
                        len(debug_segment),
                        endpoint=False,
                    )
                    plt.plot(
